...
const getTemplate = (name, token) => {
  return `
      ...
      <a style="color: #000000; font-size: 15px; text-decoration: underline;" href="https://sm.up.railway.app/user/confirm/token/${token}" target="_blank"><button style="background-color: #DD8643; border-radius: 100px; width: 150px; height: 30px; border: 1px solid; cursor: pointer;">Confirmar cuenta</button></a><br/>
